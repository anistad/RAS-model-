...
department3_dict = {'number tanks': 3, 'diameter': 14, 'HRT': 40, 'specific density': 60, 'salinity': 0.012, 'recirc degree': 0.985}
...
end_weight_department2 = 160 #g
start_weight_department3 = 160
...
fish3 = Fish(return_fish_dataframe(start_weight_department3, end_weight_department3, filename, sheet),no_fish)
fish1.plot_fish()
...
max_fish_dep3 = max_number_of_fish(fish3,end_weight_department3, RAS.department3)

#assert (max_fish_dep2/max_fish_dep1) <= 0.8, "HAVE TO ADD SOME TANKS TO THE LAST DEPARTMENTS??"

#assert (max_fish_dep3/max_fish_dep2) <= 0.8, "HAVE TO ADD SOME TANKS TO THE LAST DEPARTMENTS??"
    
    
    
fish_produced = max_fish_dep3
...
RAS.department3.fish = Fish(return_fish_dataframe(start_weight_department3, end_weight_department3, filename, sheet),fish_produced)
